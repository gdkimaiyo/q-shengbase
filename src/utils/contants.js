export const FAQS = [
  {
    ...
    desc: "Every 5 sheng words you add to the ShengBase dictionary, earns you 1 point. Also, every 5 likes of all cumulative likes from the words you add, earns you 1 point.",
  },
  {
    id: 2,
    open: false,
